...
const NigeriaTaxAct2025: React.FC = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto text-gray-800 leading-7">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">1. The inclusion of digital and virtual assets as taxable items</h2>
        <p>
        ...
        <p className="mt-2">However, there are certain exceptions:</p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">2. Compulsory tax on foreign technology companies</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">3. Provision of Value Added Tax (VAT) on Online Services</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">4. Incentive to Local Technology Companies</h2>
        <p>
        ...
        <p className="mt-2 font-semibold">Are there any exceptions for which local companies get the reliefs?</p>
        <p className="mt-2">
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">5. Provision of Research and Development (R&D) relief</h2>
        <p>
      ...
      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">6. Imposition of new requirements on Multinational Technology Companies</h2>
        <p>
      ...
      <section>
        ...
        <ul className="list-disc pl-6">
          <li>The Nigerian Tax Act, 2025, 13, 17, 144, 151, 192, 163(1)(m)</li>
        </ul>
...
export default NigeriaTaxAct2025;
